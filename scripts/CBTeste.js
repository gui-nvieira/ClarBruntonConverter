function clarBruntonSite(){
    const dipDirAux=document.getElementById('dipDir1').value;
    const dipDir=parseInt(dipDirAux);
...
function bruntonClarSite(){
    const strikeAux = document.getElementById('strike').value;
    const strike=parseInt(strikeAux);
    const dipAux = document.getElementById('dip2').value;
    const dip=parseInt(dipAux); 
